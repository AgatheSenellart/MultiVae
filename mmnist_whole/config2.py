...
project_path = '/home/asenella/scratch/clean_whole_mmnist'
...
wandb_project = "clean_mmnist_resnet"
...
def save_model(model, args):
    model.push_to_hf_hub(
        f"asenella/whole_mmnist_{model.model_name}{config_name}_seed_{args.seed}_beta_{args.beta}"
    )
