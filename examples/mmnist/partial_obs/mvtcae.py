...
train_data = MMNISTDataset(data_path="~/scratch/data/MMNIST", split="train", missing_ratio=0.5)
...
wandb_cb.setup(trainer_config, model_config, project_name="testing_mvtcae_with missing data")
