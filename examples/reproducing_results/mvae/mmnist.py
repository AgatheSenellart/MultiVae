...
wandb_cb.setup(trainer_config, model_config, project_name="reproducing_mvae_mmnist")
...
trainer._best_model.push_to_hf_hub(f"asenella/reproducing_mvae_mmnist_seed_{args.seed}")
