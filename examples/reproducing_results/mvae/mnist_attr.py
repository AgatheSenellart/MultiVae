...
class ImageEncoder(BaseEncoder):
    ...
    def forward(self, x):
        ...
        return ModelOutput(embedding = self.fc31(h),
                           log_covariance = self.fc32(h))
...
class TextDecoder(BaseDecoder):
    ...
    def forward(self, z):
        ...
        h = self.swish(self.fc3(h))
        return ModelOutput(
            reconstruction = self.softmax(self.fc4(h))) 
...
encoders = dict(images = ImageEncoder(model_config.latent_dim),
