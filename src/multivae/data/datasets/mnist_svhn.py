...
class MnistSvhn(MultimodalBaseDataset):  # pragma: no cover
    ...
    def __init__(
        ...
        **kwargs,
        ...
        i_mnist = torch.load(f"{self.path_to_idx}/mnist_idx.pt", weights_only=True)  ## !!!!WARNING!!!
        i_svhn = torch.load(f"{self.path_to_idx}/svhn_idx.pt", weights_only=True)  ## !!!!WARNING!!!
