...
@dataclass
class JNFCLIPConfig(BaseJointModelConfig):
    """
    ...
    Args:
        ...
        nb_epochs_clip (int) : The number of epochs during which to train the DCCA embeddings. Default to 30.
        embedding_clip_dim (int) : The dimension of the DCCA embedding to use. Default to 20.
        weights_clip (dict): the weights to apply to clip terms during clip pretraining. Default to None.

    """

    warmup: int = 10
    nb_epochs_clip: int = 100
    embedding_clip_dim: int = 20
    weights_clip : dict = None
    beta: float = 1.0
