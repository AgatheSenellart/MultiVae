...
class BaseJointModel(BaseMultiVAE):
    ...
    def compute_joint_nll(self, inputs : MultimodalBaseDataset, K:int=1000, batch_size_K:int=100):
        ...
        print("Started computing the negative log_likelihood on inputs. This function"
        ...
        for i in range(n_data):
            ...
            while start_idx < stop_idx :
                ...
                for mod in inputs.data:
                    ...
                    mu_recon = decoder(latents)['reconstruction'] # (batch_size_K, nb_channels, w, h)
